...
public class Engine2D {
    ...
    public static void updatePhysics(World world) {
        ...
        for (RigidBody2D rb2d : rb2dList) {
            if (!rb2d.isStatic()) {
                ...
                rb2d.applyForce(new Vector2f(0.08f, 0f));
                rb2d.updateVelocity();
    ...
    private static void resolveCollision(Object2D o1, Object2D o2) {
       ...
       /* if (Math.abs(absDX - absDY) < 0.1f) {
            ...
            // Velocity component
            o1.getRb2d().setVX(-o1.getRb2d().getVX() * o1.getRb2d().getRestitution());
            ...
            // Velocity component
            o1.getRb2d().setVY(-o1.getRb2d().getVY() * o1.getRb2d().getRestitution());
            if (Math.abs(o1.getRb2d().getVY()) < treshold) {
                o1.getRb2d().setVY(0.0f);
            }
        }
